...
<div class="navigation">
	<div class="box_path">
		:: <a href="#">Example Forum</A> &nbsp;/&nbsp; <a href="/personal/">Паспорт</a> &nbsp;/&nbsp; <a href="/personal/payment/">Пополнение баланса</a>&nbsp;/&nbsp; SMS
    </div>
</div>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	...
	<a href="#" onclick="window.open('http://smszamok.ru/client/izamok.php?{*00000*}00000&text=303030&bg=D0D0D0', '_blank', 'location=no,height=700,width=700', false);">Инструкции по отправке SMS.</a><br><br>
